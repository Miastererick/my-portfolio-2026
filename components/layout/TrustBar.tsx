...
export function TrustBar({ placement = "fixed" }: TrustBarProps) {
  ...
  return (
    <div className={outer}>
      <footer
        className="pointer-events-auto flex h-[80px] w-full max-w-[1486px] items-center overflow-hidden rounded-[22px] border-t border-white/10 bg-black/20 px-8 backdrop-blur-sm"
        role="region"
        aria-label="合作品牌"
      >
